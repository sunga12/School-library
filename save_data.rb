...
class SaveData
  ...
  def save_people(people)
    ...
    people.each do |person|
      person_obj = { id: person.id, name: person.name, age: person.age,
                     has_permission: person.parent_permission, type: person.class }
  ...
  def save_rentals(rentals)
    ...
    rentals.each do |rental|
      rental_obj = { date: rental.date, title: rental.book.title, author: rental.book.author, id: rental.person.id,
                     name: rental.person.name, age: rental.person.age, has_permission: rental.person.parent_permission,
